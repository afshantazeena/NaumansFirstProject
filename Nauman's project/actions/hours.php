...
<?php 
	try {
		...
		$stmt = $conn->prepare("INSERT INTO `hourscalculator`(`date`, `signInTime`, `signOutTime`) VALUES(:date, :signInTime, :signOutTime)");
		$stmt->execute(array(':date' => $_POST['DA'], ':signInTime' => $_POST['SIT'], ':signOutTime' => $_POST['SOT']));
